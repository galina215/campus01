...
CREATE TABLE `ad` (
  ...
  `sh` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'checked'
...
(1, '', '轉知臺北教育大學與臺灣師大合辦第11屆麋研齋全國硬筆書法比賽活動\r\n\r\n\r\n', 'checked'),
(2, '', '轉知:法務部辦理「第五屆法規知識王網路闖關競賽辦法\r\n', 'checked'),
(3, '', '轉知2012年全國青年水墨創作大賽活動\r\n\r\n', 'checked'),
(4, '', '欣榮圖書館101年悅讀達人徵文比賽，歡迎全校師生踴躍投稿參加', 'checked'),
(5, '', '轉知:教育是人類升沉的樞紐-2013教師生命成長營', 'checked');
...
CREATE TABLE `bottom` (
  `id` int(10) UNSIGNED NOT NULL,
  `bottom` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'index.php?do=login', '管理登入', 'checked', 0),
(2, 'skidoo', '網站首頁', 'checked', 0),
(9, 'djzszj', 'fzdh', 'checked', 1),
(10, 'dxjxs', 'jdxtx', 'checked', 1),
(11, 'ew', 'sf', 'checked', 2),
(12, 'sd', 'stejnn', 'checked', 2);
